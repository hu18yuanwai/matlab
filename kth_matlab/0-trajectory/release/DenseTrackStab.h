...
static float scale_stride = sqrt(2);
static char* bb_file = NULL;
...
static float min_var = sqrt(3);
static float max_var = 50;
static float max_dis = 20;
